...
exports.cmp001 = {
    ...
    check(ctx) {
        ...
        const promptInjection = /user_input|message|request\./.test(Array.from(ctx.files.values()).join("\n"));
        const destructiveTool = /\b(delete|remove|send|publish)\b/i.test(Array.from(ctx.files.values()).join("\n"));
...
//# sourceMappingURL=cmp-001.js.map